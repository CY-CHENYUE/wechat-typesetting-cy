...
description: "微信公众号文章多模板排版技能。将纯文本或Markdown转换为全内联样式HTML，支持blue-minimal（白底蓝色杂志风）和dark-tech（黑底橙红科技风）两套模板，自动匹配模板、生成标题Banner、金句区块、数据卡片、时间线、排名列表等组件，输出可直接粘贴到公众号编辑器的HTML文件并在浏览器预览。也可对已有HTML进行排版规范性检查。当用户提到'微信文章'、'公众号文章'、'发公众号'、'帮我排版'、'公众号排版'、'排版成微信格式'、'蓝色模板'、'暗黑模板'、'科技风排版'时触发。"
---
